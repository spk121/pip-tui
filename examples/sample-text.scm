...
;; Author: Jeppe Aakjær
;; http://www.gutenberg.org/files/24747/24747-0.txt
(define danish-text
...
;; Title: Agamemnon
;; Author: Aeschylous
;; http://www.gutenberg.org/files/39536/39536-0.txt
(define greek-text
...
του, μετά της παλλακής του Κασσάνδρας.")

(define hebrew-text
  "א לפניכם ספר קורות חייו של ישוע המשיח, אשר מוצאו מיוחס לדוד המלך ולאברהם אבינו:

2 אברהם היה אביו של יצחק; יצחק היה אביו של יעקב; יעקב היה אביהם של יהודה ואחיו
